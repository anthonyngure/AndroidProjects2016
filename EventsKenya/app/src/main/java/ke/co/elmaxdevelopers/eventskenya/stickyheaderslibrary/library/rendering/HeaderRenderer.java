package ke.co.elmaxdevelopers.eventskenya.stickyheaderslibrary.library.rendering;
...
public class HeaderRenderer {
   ...
   * orientation are clipped so they look accurate, but the headers are not being drawn getInstance the
